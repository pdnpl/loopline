...
tests/            340 tests, including full pointer and keyboard playthroughs
...
Nineteen architecture decision records live in [`docs/adr/`](docs/adr/README.md).
